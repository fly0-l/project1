...
for i in datasets:
    ...
    data_normalized, labels = full.get_train_test_dataset(i)
    # 十折交叉验证
    metrics = full.cross_validate(data_normalized, labels, n_estimators=n_estimators[j], lambda_ncl=lambda_ncl[j],
