...
for i in datasets:
    n_estimators=[1,1,1,1]
    data_normalized, labels = d_cnn.get_train_test_dataset(i)
    # 十折交叉验证
    metrics = d_cnn.cross_validate(data_normalized, labels, n_estimators=n_estimators[j],
